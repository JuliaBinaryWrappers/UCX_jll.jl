...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import UCX_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("16e4e860-d6b8-5056-a518-93e88b6392ae"))
platforms = [Pkg.Artifacts.unpack_platform(e, "UCX", artifacts_toml) for e in artifacts["UCX"]]
...
if best_platform === nothing
    @debug("Unable to load UCX; unsupported platform $(triplet(platform_key_abi()))")
else
